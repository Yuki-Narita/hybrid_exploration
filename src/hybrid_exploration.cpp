...
int main(int argc, char** argv){
	ros::init(argc, argv, "hybrid_exploration");
	ros::NodeHandle h;

	std::cout << "hybrid_exploration program is begun" << std::endl;
	std::cout << "start: sensor-based exploration" << std::endl;
	system("rosrun hybrid_exploration hybrid_sensor_based_exploration"); 
	...
	system("rosrun hybrid_exploration hybrid_vector_explore_program");
